...
class MajorCategoryController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(MajorCategory $major_categories)
    {
        return view('dashboard.major_categories.edit', compact('major_categories'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, MajorCategory $major_categories)
    {
        $major_categories->name = $request->input('name');
        $major_categories->description = $request->input('description');
        $major_categories->update();
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(MajorCategory $major_categories)
    {
        $major_categories->delete();
